 ...
 * @author EmanuelHurt
 */
public class SaleModal extends javax.swing.JPanel {
    ...
    public SaleModal(double percenDiscount, Product prod, ProductSaleController saleController) {
        initComponents();
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        try {
            ...
            ErrorModal errorModal = new ErrorModal("El campo cantidad debe contener un valor numérico");
        }
